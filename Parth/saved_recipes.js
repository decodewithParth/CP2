...
if (savedRecipes.length) {
    savedRecipes.map((savedRecipes,index)=> {
        ...
        <figure class="card-media img-holder">
            <img src="${image}" width="${width}" height="${height}" loading="lazy" alt="${title}" class="img-cover">
        </figure>
        ...
        <div class="card-body">
            ...
            <div class="meta-wrapper">
                ...
                <span class="material-symbol-outlined bookmark" aria-hidden="true">bookmark</span>
                </button>
            </div>
        </div>
        `
